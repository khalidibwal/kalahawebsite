...
{{-- welcome --}}
@section('welcomeimg')
<section class="ftco-cover" style="background-image: url(images/icons/bg_den.jpg)" id="section-home">
@endsection
@section('title')
<img src="images/icons/logo-den.png" alt="IMG-OUR" class="ftco-animate">
@endsection
...
@section('formcontact')
<form action="/Denofkalaha/store" method="post">
    {{ csrf_field() }}
...
<form action="/Denofkalaha/reservation" method="post">
  {{ csrf_field() }}
  <div class="row">
